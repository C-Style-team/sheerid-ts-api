export type SheerIDVerificationMethod = "INSTANT" | "MANUAL";
...
export type SheerIDMoverStatus = "HOME_BUYER" | "OTHER_MOVER";
...
export type SheerIDReportStatus = "PENDING" | "COMPLETE" | "ERROR" | "DELETED";

export type SheerIDVerificationModeInclusion = "ALL" | "LIVE" | "TEST";

export type SheerIDRewardEligibility = "ELIGIBLE" | "INELIGIBLE";
