...
type SheerIDVerificationResponse = SheerIDResponse &
  Readonly<{
...
export type SheerIDNewAgeVerificationResponse = SheerIDVerificationResponse &
  Readonly<{
    minAge: number;
    maxAge: number;
  }>;

export type SheerIDMilitaryVerificationResponse = SheerIDVerificationResponse &
  Readonly<{
    availableStatuses: SheerIDMilitaryStatus[];
  }>;

export type SheerIDNewFirstResponderVerificationResponse =
  SheerIDVerificationResponse &
    Readonly<{
      availableStatuses: SheerIDFirstResponderStatus[];
    }>;

export type SheerIDNewMedicalProfessionalVerificationResponse =
  SheerIDVerificationResponse &
    Readonly<{
      availableStatuses: SheerIDMedicalProfessionalStatus[];
    }>;

export type SheerIDNewEmploymentVerificationResponse =
  SheerIDVerificationResponse &
    Readonly<{
      availableStatuses: "EMPLOYEE";
    }>;

export type SheerIDNewMarketplaceVerificationResponse =
  SheerIDVerificationResponse &
    Readonly<{
      verificationToken: string;
    }>;

export type SheerIDDocumentReviewResponse = SheerIDVerificationResponse &
  Readonly<{
    segment: SheerIDSegment;
...
export type SheerIDSuccessResponse = SheerIDResponse &
  Readonly<{
    verificationId: string;
...
export type SheerIDPendingResponse = SheerIDResponse &
  Readonly<{
    statusUrl: string;
...
export type SheerIDErrorResponse = SheerIDResponse &
  Readonly<{
    verificationId: string;
    currentStep: SheerIDVerificationStep;
    errorIds: SheerIDErrorId[];
...
export type SheerIDSsoResponse = SheerIDResponse &
  Readonly<{
    verificationId: string;
    currentStep: SheerIDVerificationStep;
    loginUrl: string;
...
export type SheerIDSMSLoopResponse = SheerIDResponse &
  Readonly<{
    verificationId: string;
    currentStep: SheerIDVerificationStep;
    retryUrl: string;
...
export type SheerIDCancellableResponse = SheerIDResponse &
  Readonly<{
    verificationId: string;
    currentStep: SheerIDVerificationStep;
    submissionUrl: string;
...
export type SheerIDEmailLoopResponse = SheerIDResponse &
  Readonly<{
    verificationId: string;
    currentStep: SheerIDVerificationStep;
    submissionUrl: string;
...
export type SheerIDConsolationResponse = SheerIDResponse &
  Readonly<{
    verificationId: string;
    currentStep: SheerIDVerificationStep;
...
export type SheerIDOverrideResponse = SheerIDResponse &
  Readonly<{
    verificationId: string;
    currentStep: SheerIDVerificationStep;
    submissionUrl: string;
...
export type SheerIDNewCollectIdentifierResponse = SheerIDResponse &
  Readonly<{
    verificationId: string;
    currentStep: SheerIDVerificationStep;
    submissionUrl: string;
...
export type SheerIDCompleteAuthenticationResponse = SheerIDResponse &
  Readonly<{
    verificationId: string;
    currentStep: SheerIDVerificationStep;
    submissionUrl: string;
    ...
    messages: {
      ...
      step: {
        ...
        consolation?: {
          ...
          any,
          "title" | "subtitle" | "verificationOnly"
        >;
        emailLoop?: {
          title?: string;
          ...
          any,
          "title" | "subtitleWithoutEmail" | "skipEmail"
        >;
      };
      errorId: {
...
export type SheerIDOverrideEmailLoopResponse = {
  verificationId: string;
  currentStep: SheerIDVerificationStep;
  submissionUrl: string;
  errorIds?: Array<SheerIDErrorId>;
